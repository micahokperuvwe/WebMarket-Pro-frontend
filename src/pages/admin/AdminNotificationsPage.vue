    ...
    <div class="space-y-10">
      <header class="flex flex-col gap-2 md:flex-row md:items-end md:justify-between">
        <div class="space-y-1">
          ...
          <p class="text-lg font-medium text-secondary">Manage your inquiries and system messages.</p>
        </div>
        
        <div class="flex items-center gap-4">
           <div class="flex h-12 items-center gap-2 rounded-2xl bg-primary/5 px-4 text-sm font-bold text-secondary">
      ...
      <div class="glass-panel overflow-hidden rounded-[2.5rem] border-primary/5 bg-primary/5">
        <div v-if="isLoading" class="flex flex-col items-center justify-center p-32 text-center">
          ...
          <p class="mt-6 font-display text-xl font-bold tracking-tight text-secondary">Fetching messages...</p>
        </div>
        
        <div v-else-if="notifications.length === 0" class="flex flex-col items-center justify-center p-32 text-center">
          <div class="flex h-20 w-20 items-center justify-center rounded-3xl bg-primary/5 text-primary/20">
             <svg class="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0h-2.586a1 1 0 00-.707.293l-2.414 2.414a1 1 0 01-.707.293h-3.172a1 1 0 01-.707-.293l-2.414-2.414A1 1 0 006.586 13H4"/></svg>
          </div>
          <p class="mt-8 font-display text-2xl font-bold tracking-tight text-secondary">Your inbox is empty</p>
          <p class="mt-2 text-secondary/40">When users contact you, their messages will appear here.</p>
        </div>
        ...
        <div v-else class="divide-y divide-primary/5">
          <article 
            ...
            :key="item.id"
            class="group relative flex flex-col gap-6 p-8 transition-all duration-300 hover:bg-primary/5 md:flex-row md:items-start lg:p-10"
          ...
          >
            ...
            <div 
              ...
              :class="item.read ? 'bg-primary/5 text-primary/20' : 'bg-gradient-premium text-canvas shadow-xl shadow-gold-500/10'"
            >
            ...
            <div class="flex-1 space-y-4">
              ...
              <div class="flex flex-wrap items-center gap-4 pt-2">
                 <button 
                   ...
                   class="flex items-center gap-2 rounded-xl bg-gold-500/10 px-6 py-3 text-sm font-black uppercase tracking-widest text-gold-400 transition-all hover:bg-gold-500 hover:text-canvas"
                 >
                 ...
                 <a 
                   ...
                   class="flex items-center gap-2 rounded-xl bg-primary/5 px-6 py-3 text-sm font-black uppercase tracking-widest text-mint-400 transition-all hover:bg-primary/10 hover:text-mint-300"
                 >
