    ...
    <main class="min-h-[80vh] flex items-center justify-center p-6">
      <div class="w-full max-w-md space-y-8">
        <header class="text-center space-y-2">
           <h1 class="font-display text-4xl font-bold tracking-tight">Access <span class="text-gradient">Pro</span></h1>
           <p class="text-sm text-white/50">Manage your digital assets and marketplace profile.</p>
        </header>
        ...
        <section class="glass-panel overflow-hidden rounded-[2.5rem] border shadow-2xl">
            ...
            <div class="space-y-4">
              <div class="space-y-2">
                ...
                <div class="relative group">
                  <div class="absolute left-4 top-1/2 -translate-y-1/2 text-white/30 transition-colors group-focus-within:text-gold-400">
                  ...
                  <input
                    ...
                    type="email"
                    required
                    class="w-full rounded-2xl border border-white/10 bg-white/5 py-4 pl-12 pr-4 text-sm outline-none transition-all focus:border-gold-400/50 focus:bg-white/10"
          ...
          <footer class="border-t border-white/5 bg-white/5 p-6 text-center">
            <p class="text-sm text-white/40">
              ...
              <router-link to="/register" class="font-bold text-white hover:text-gold-400 transition-colors">Register here</router-link>
            </p>
          </footer>
        </section>
      </div>
